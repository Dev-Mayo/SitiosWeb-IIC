...
$errores = [];
$datos   = $responsable; // carga los valores actuales por defecto
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        try {
            Responsable::editar($id, $datos['nombre'], $datos['apellidos'], $datos['identificacion']);
...
<div class="container py-4" style="max-width:540px">
  <h2 class="mb-4">Editar Responsable</h2>
