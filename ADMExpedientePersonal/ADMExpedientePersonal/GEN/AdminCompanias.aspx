<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"
    CodeBehind="AdminCompanias.aspx.cs"
    Inherits="ADMExpedientePersonal.GEN.AdminCompanias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card-custom bg-white">
        <div class="card-header-custom">
            <h5 class="fw-bold mb-0">Administración de Compañías</h5>
        </div>
        ...
        <div class="p-4">
            ...
            <asp:UpdatePanel ID="upMain" runat="server">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hfCodigoCompania" runat="server" />

                    <asp:GridView ID="gvCompanias" runat="server"
                        CssClass="table table-striped table-bordered"
                        AutoGenerateColumns="False"
                        DataKeyNames="codigo_compania"
                        AllowPaging="true"
                        PageSize="10"
                        PagerStyle-CssClass="grid-pager"
                        OnPageIndexChanging="gvCompanias_PageIndexChanging"
                        OnRowCommand="gvCompanias_RowCommand">

                        <Columns>
                            <asp:BoundField DataField="codigo_compania" HeaderText="Código" />
                            ...
                            <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkEditar" runat="server"
                                        CommandName="Editar"
                                        CommandArgument='<%# Eval("codigo_compania") %>'
    ...
    <div id="modalCompania" runat="server" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">

                <div class="modal-header card-header-custom text-white">
                    <h5 class="modal-title">Formulario Compañía</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <div class="modal-body">
                    <asp:UpdatePanel ID="upModalCompania" runat="server">
                        <ContentTemplate>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnGuardarCompania" runat="server"
                        Text="Guardar"
                        CssClass="btn btn-primary"
                        OnClick="btnGuardarCompania_Click" />
    ...
    <script type="text/javascript">
        function showCompaniaModal() {
            var modalEl = document.getElementById('<%= modalCompania.ClientID %>');
            var modal = bootstrap.Modal.getOrCreateInstance(modalEl);
            modal.show();
        }

        function hideCompaniaModal() {
            var modalEl = document.getElementById('<%= modalCompania.ClientID %>');
